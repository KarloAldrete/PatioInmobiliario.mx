...
export default function Page() {
  ...
  const houses = [
    {
      image: "https://res.akamaized.net/domain/image/upload/t_web/v1629867843/65A_Champion_St_Brighton_VIC_1_bunjuj.jpg",
      city: "San Francisco",
      estate: "California",
      price: 1000000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bHV4dXJ5JTIwaG91c2V8ZW58MHx8MHx8fDA%3D",
      city: "Chicago",
      estate: "Illinois",
      price: 900000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1531971589569-0d9370cbe1e5?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Miami",
      estate: "Florida",
      price: 650000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "New York",
      estate: "New York",
      price: 1500000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1628744448840-55bdb2497bd4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzh8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Los Angeles",
      estate: "California",
      price: 800000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1513584684374-8bab748fbf90?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDJ8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Denver",
      estate: "Colorado",
      price: 1100000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1622015663319-e97e697503ee?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDN8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Boston",
    ...
    {
      image: "https://images.unsplash.com/photo-1512915922686-57c11dde9b6b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nzl8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "San Diego",
      estate: "California",
      price: 1300000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1509600110300-21b9d5fedeb7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODN8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Portland",
      estate: "Oregon",
      price: 850000,
      currency: "USD",
    ...
    {
      image: "https://images.unsplash.com/photo-1581974206939-b42731ea9dc9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OTR8fGx1eHVyeSUyMGhvdXNlfGVufDB8fDB8fHww",
      city: "Philadelphia",
      estate: "Pennsylvania",
      price: 700000,
      currency: "USD",
    ...
    <div className="w-full flex flex-col items-center justify-start pb-10">
      ...
      <div className="w-full max-w-[1320px] h-auto flex flex-col items-center justify-center pt-[80px] pb-[40px] cursor-default gap-2">
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <span className=" text-xl leading-5 font-semibold text-[#A0A0A0]">Diseños unicos, espacios que inspiran. Tu próximo inmueble te espera.</span>
      ...
      <div className="w-full max-w-[1320px] flex flex-wrap justify-center gap-5 px-[60px]">
        ...
        {houses.map((house, index) => (
          <div key={index} className="h-auto col-span-1 border border-[#E5E7EB] w-auto min-w-[280px] max-w-[285px] rounded-md p-1 flex flex-col items-start justify-start gap-2">
            ...
            <picture>
              <img className="w-auto min-h-[180px] rounded" style={{ aspectRatio: '16 / 9' }} alt='houses' src={house.image} />
            </picture>
            ...
            <div className="w-full h-full flex flex-col items-start justify-between gap-2 pb-1 px-1 cursor-default">
              ...
              <div className="flex flex-col items-start justify-start w-full gap-1">
                ...
                <div className="w-full h-auto flex flex-row items-center justify-between">
                  ...
                  <span className=" text-sm leading-[22px] text-black font-medium">{house.estate}</span>
